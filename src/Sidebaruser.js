...
import {  faHome, faTasks, faInbox, faChartLine, faBriefcase, faBullseye, faStar, faPlus} from '@fortawesome/free-solid-svg-icons';




export default function Sidebaruser({ tasks, toggleAddFormVisibility,isSidebarOpen }) {
  return (
    ...
    /*<div className={isSidebarOpen ? "sidebar show" : "sidebar"}>
        <ul>
          ...
          <li><a href to="/tasks"><FontAwesomeIcon icon={faTasks} /> My Task</a></li>
         
         
          <li><a href='/users'><FontAwesomeIcon icon={faInbox} /> Users</a></li>

          <hr />
          <li>
            <li><a href="#"> Insights <span className="add-icon"><FontAwesomeIcon icon={faPlus} /></span></a></li> 
           
              <li><a href="#"><FontAwesomeIcon icon={faChartLine} /> Reporting</a></li>
              <li><a href="#"><FontAwesomeIcon icon={faBriefcase} /> Portfolio</a></li>
              <li><a href="#"><FontAwesomeIcon icon={faBullseye} /> Goals</a></li>
           
          </li>
          <li>
             <li><a href="#"> Starred </a></li>
           
              <li><a href="#"><FontAwesomeIcon icon={faStar} /> Star items Appear Here</a></li>
           
          </li>
          <li>
             <li><a >Projects <span className="add-icon"  onClick={toggleAddFormVisibility}><FontAwesomeIcon icon={faPlus} /></span></a></li>
            <ul>
              {tasks.map((task, index) => (
                 <li key={index}>
                   <a href="#"><FontAwesomeIcon icon={faBriefcase} /> {task.taskName}</a>
                </li>
                   ))}
            </ul>
          </li>
          <li><a href="#">Teams <span className="add-icon"><FontAwesomeIcon icon={faPlus} /></span></a></li>
          <hr />
          <button className="btn">Invite Teammate</button>
          <button className="btn btn-help">Help with Asana</button>
        </ul>
...
<div id="application-sidebar-dark" class=" top-[70px]  hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-gray-900 border-e border-gray-800 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
 

  <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
    <ul class="space-y-1.5">
      <li>
        <a class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white-300 focus:outline-none focus:ring-1 focus:ring-gray-600" href="/dashboard">
      ...
      <li class="hs-accordion" id="users-accordion">
        ...
        <li><a class="flex items-center gap-x-3 py-2 px-2.5 bg-gray-700 text-sm text-white rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-600" href="/users">
      ...
      <a class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white-300 focus:outline-none focus:ring-1 focus:ring-gray-600" href="/projects">
